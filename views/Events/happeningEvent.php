...
<div class="container-fluid ">
    <nav class="nav"> <!--display time event-->
      ...
      <a class="nav-link" href="<?php echo ROOT_PATH; ?>Events/happeningEvent" style="color:red" >Happening</a>
...
<?php if($item['event_start_date'] == date('Y-m-d')) : ?>

    <hr>
  <!-- Grid row -->
  <div class="row m-0" style="word-wrap:break-word; word-break:break-all;">
